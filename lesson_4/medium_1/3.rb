...
# The drawback is that this makes the ability to reassign the quantity state
# within the InvoiceEntry object public. We could also add attr_writer but make
# it a private method.
